...
parameter= c("beta","gamma","rho", "Reproduction")
...
summary(fit_seir, pars=c("beta", "gamma", "Reproduction"), probs = c(0.1,0.9))
stan_dens(fit_seir, pars=c("beta", "gamma", "Reproduction"))